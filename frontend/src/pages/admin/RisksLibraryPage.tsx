...
export default function RisksLibraryPage() {
    ...
    // 2. Subir Nuevo PDF (Función mejorada)
    const handleUpload = async (id: string, file: File) => {
        ...
        try {
            // Usamos la nueva ruta específica para agregar protocolos
                                                    ...
                                                    risk.protocols.map((proto: any) => (
                                                        <div key={proto.id} className="flex items-center gap-3 bg-white border border-slate-100 p-2 rounded-md shadow-sm w-full max-w-md hover:border-purple-200 transition-colors">
                                                            ...
                                                            <Tooltip>
                                                                ...
                                                                <TooltipContent><p>Eliminar este documento</p></TooltipContent>
                                                            </Tooltip>
                                                        </div>
                                                    ))
                                                ) : (
                                            ...
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <Tooltip>
                                                        ...
                                                        <TooltipContent><p>Subir otro documento a este riesgo</p></TooltipContent>
                                                    </Tooltip>
                                                </div>
                                                ...
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent><p>Eliminar Agente de Riesgo Completo</p></TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </TableCell>
                                    </TableRow>
