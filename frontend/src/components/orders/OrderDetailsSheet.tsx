...
import { 
  User, FileText, Calendar, Activity, AlertTriangle, CheckCircle2 
} from 'lucide-react';
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="overflow-y-auto sm:max-w-[600px]">
        ...
        <div className="space-y-6">
          ...
          {/* 2. RIESGOS DETECTADOS (Aquí se ve el detalle) */}
          <section className="space-y-3">
          ...
          <section className="space-y-3">
            ...
            <div className="flex flex-col gap-2">
                {order.examBatteries?.map(bat => (
                    <div key={bat.id} className="flex items-center gap-2 bg-green-50 border border-green-200 px-3 py-2 rounded-md text-green-800 text-sm font-medium">
